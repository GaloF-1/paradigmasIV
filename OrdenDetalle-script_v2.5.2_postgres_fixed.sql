...
CREATE TABLE categoria (id_categoria INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
...
CREATE TABLE proveedor (id_proveedor INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
   ,empresa VARCHAR(255)
...
CREATE TABLE proveedor_categoria (id_proveedor_categoria INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
...
CREATE TABLE producto (id_producto INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
   ,descripcion VARCHAR(255)
   ,id_proveedor INTEGER
   ,id_categoria INTEGER
...
CREATE TABLE promocion (id_promocion INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
           ,descripcion VARCHAR(255));;
...
CREATE TABLE promocion_vigencia (id_promocion_vigencia INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
           ,id_promocion INTEGER
           ,fecha_inicio DATE
           ,fecha_fin DATE);;
ALTER TABLE promocion_vigencia ADD FOREIGN KEY (id_promocion) REFERENCES promocion (id_promocion);
INSERT INTO promocion_vigencia VALUES (10 ,1,now(), now() + interval '7 day');
INSERT INTO promocion_vigencia VALUES (11,1,now() - interval '15 day', now() - interval '10 day');
INSERT INTO promocion_vigencia VALUES (12,1,now() - interval '25 day', now() - interval '30 day');
INSERT INTO promocion_vigencia VALUES (20,2,now() - interval '2 day', now() + interval '5 day');
INSERT INTO promocion_vigencia VALUES (21,2,now() - interval '18 day', now() - interval '13 day');
INSERT INTO promocion_vigencia VALUES (30,3,now() - interval '26 day', now() - interval '8 day');
INSERT INTO promocion_vigencia VALUES (31,3,now() - interval '4 day', now() + interval '1 day');
INSERT INTO promocion_vigencia VALUES (32,3,now() + interval '4 day', now() + interval '10 day');

CREATE TABLE promocion_producto (id_promocion_producto INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
           ,id_producto INTEGER
...
CREATE TABLE tipo_cliente (id_tipo_cliente INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
           ,descripcion VARCHAR(255));;
INSERT INTO tipo_cliente VALUES (1,'Consumidor Final');
INSERT INTO tipo_cliente VALUES (2,'Revendedor');

CREATE TABLE cliente (id_cliente INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
           ,id_usuario INTEGER
           ,nombre VARCHAR(255)
           ,direccion VARCHAR(255)
...
CREATE TABLE empleado (id_empleado INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
           ,nombre VARCHAR(255)
           ,id_jefe INTEGER);;
...
CREATE TABLE orden (id_orden INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
   ,id_cliente INTEGER
   ,id_empleado INTEGER
   ,fecha_generada DATE
...
CREATE TABLE detalle_orden (id_detalle_orden INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
   ,id_orden INTEGER
   ,id_producto INTEGER
   ,cantidad INTEGER);;
